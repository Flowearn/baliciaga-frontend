...
<launched> pid=81098
[pid=81098][err] /Users/troy/Library/Caches/ms-playwright/webkit-2158/pw_run.sh: 第 7 行：81103 Bus error: 10           DYLD_FRAMEWORK_PATH="$DYLIB_PATH" DYLD_LIBRARY_PATH="$DYLIB_PATH" "$PLAYWRIGHT" "$@"
Call log:
  - <launching> /Users/troy/Library/Caches/ms-playwright/webkit-2158/pw_run.sh --inspector-pipe --headless --no-startup-window
  - <launched> pid=81098
  - [pid=81098][err] /Users/troy/Library/Caches/ms-playwright/webkit-2158/pw_run.sh: 第 7 行：81103 Bus error: 10           DYLD_FRAMEWORK_PATH="$DYLIB_PATH" DYLD_LIBRARY_PATH="$DYLIB_PATH" "$PLAYWRIGHT" "$@"
