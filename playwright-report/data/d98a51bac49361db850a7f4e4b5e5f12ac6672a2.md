...
- Name: Dark UI Pages >> MyListings page renders with dark theme
- Location: /Users/troy/开发文档/Baliciaga/frontend/tests/darkUI.visual.spec.ts:1:89
...
<launched> pid=37546
[pid=37546][err] /Users/troy/Library/Caches/ms-playwright/webkit-2158/pw_run.sh: 第 7 行：37551 Bus error: 10           DYLD_FRAMEWORK_PATH="$DYLIB_PATH" DYLD_LIBRARY_PATH="$DYLIB_PATH" "$PLAYWRIGHT" "$@"
Call log:
  - <launching> /Users/troy/Library/Caches/ms-playwright/webkit-2158/pw_run.sh --inspector-pipe --headless --no-startup-window
  - <launched> pid=37546
  - [pid=37546][err] /Users/troy/Library/Caches/ms-playwright/webkit-2158/pw_run.sh: 第 7 行：37551 Bus error: 10           DYLD_FRAMEWORK_PATH="$DYLIB_PATH" DYLD_LIBRARY_PATH="$DYLIB_PATH" "$PLAYWRIGHT" "$@"
